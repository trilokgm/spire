...
CREATE TABLE IF NOT EXISTS "registered_entries" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"deleted_at" datetime,"entry_id" varchar(255),"spiffe_id" varchar(255),"parent_id" varchar(255),"ttl" integer,"delegated" varchar(255) );
...
CREATE TABLE IF NOT EXISTS "registered_entries" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"entry_id" varchar(255),"spiffe_id" varchar(255),"parent_id" varchar(255),"ttl" integer,"delegated" varchar(255) );
...
CREATE TABLE IF NOT EXISTS "registered_entries" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"entry_id" varchar(255),"spiffe_id" varchar(255),"parent_id" varchar(255),"ttl" integer, "delegated" varchar(255));
INSERT INTO registered_entries VALUES(1,'2018-09-25 15:06:15.092674-06:00','2018-09-25 15:06:15.092674-06:00','00000000-0000-0000-0000-000000000001','spiffe://eXAMPLe.org/nODe','spiffe://eXAMPLe.org/spire/agent/join_token/13f1db93-6018-4496-8e77-6de440a174ed',0,'');
INSERT INTO registered_entries VALUES(2,'2018-09-25 15:06:49.602113-06:00','2018-09-25 15:06:49.602113-06:00','00000000-0000-0000-0000-000000000002','spiffe://eXAMPLe.org/bLOg','spiffe://eXAMPLe.org/nODe',3600,'');
CREATE TABLE IF NOT EXISTS "join_tokens" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"token" varchar(255),"expiry" bigint );
CREATE TABLE IF NOT EXISTS "selectors" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"registered_entry_id" integer,"type" varchar(255),"value" varchar(255) );
